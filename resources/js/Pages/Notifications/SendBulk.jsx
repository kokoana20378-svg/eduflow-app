...
export default function SendBulk() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('notifications.bulk'));
    };

    return (
        <AdminLayout title="إرسال جماعي">
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-800 dark:text-white">إرسال جماعي</h1>
                <p className="text-gray-500 dark:text-gray-400">إرسال إشعارات جماعية للطلاب أو أولياء الأمور</p>
            </div>
            ...
            <div className="mx-auto max-w-2xl rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex items-center gap-3 pt-4">
                        <PrimaryButton disabled={processing}>إرسال</PrimaryButton>
                        <Link
