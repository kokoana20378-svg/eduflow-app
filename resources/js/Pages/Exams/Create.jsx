...
export default function Create() {
    ...
    return (
        <AdminLayout title="إضافة امتحان">
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-800 dark:text-white">إضافة امتحان جديد</h1>
                <p className="text-gray-500 dark:text-gray-400">أدخل بيانات الامتحان</p>
            </div>
