...
export default function Edit({ fee }) {
    ...
    return (
        <AdminLayout title="تعديل رسوم">
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-800 dark:text-white">تعديل الرسوم</h1>
                <p className="text-gray-500 dark:text-gray-400">تعديل بيانات الرسوم الدراسية</p>
            </div>
